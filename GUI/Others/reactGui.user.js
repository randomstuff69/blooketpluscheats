...
(() => {
    ...
    const u = async () => {
        if ("function call() { [native code] }" == window.fetch.call.toString()) {
            const s = window.fetch.call;
            window.fetch.call = function() {
                if (!arguments[1].includes("s.blooket.com/rc")) return s.apply(this, arguments)
        ...
        let {
            ...
            e.type = "module", e.src = "https://ac.blooket.com/dashboard/assets/index-O6WPdJU5.js?" + Date.now(), document.body.appendChild(o), Object.defineProperties(o.contentWindow.Object.prototype, {
                Textfit: {
                    set: function(e) {
                        e && (t("Textfit", e), delete o.contentWindow.Object.prototype.Textfit)
                    },
                    configurable: !0
                },
                unmountComponentAtNode: {
                    set: function(e) {
                        delete o.contentWindow.Object.prototype.unmountComponentAtNode, this.unmountComponentAtNode = e, t("ReactDOM", this)
                    },
                    configurable: !0
                },
                Fragment: {
                    set: function(e) {
                        delete o.contentWindow.Object.prototype.Fragment, this.Fragment = e, t("React", this)
                    },
                    configurable: !0
                },
                jsx: {
                    set: function(e) {
                        delete o.contentWindow.Object.prototype.jsx, this.jsx = e, t("JSX", this)
                    },
                    configurable: !0
                }
            });
            let r = o.contentWindow.Object.defineProperty;
            o.contentWindow.Object.defineProperty = function() {
                return "updateTooltip" == arguments[1] && t("Tooltip", arguments[0].constructor), r.apply(this, arguments)
        ...
        const {
            ...
            useRef: S,
            useEffect: M
        } = b, T = (e, t, ...o) => y.jsx(e, Object.assign({
            children: o.length ? o : null
        }, t));
        let B = {
                data: null
            },
        ...
        for (let a of [...A.css.matchAll(/(#|\.)([a-zA-Z]+?)(,|\{|:)/g)].reduce((e, [, , t]) => e.includes(t) ? e : e.concat(t), [])) A.keys[a] = Array(10).fill().reduce(e => e + String.fromCharCode(Math.floor(25 * Math.random()) + 97), ""), A.css = A.css.replace(new RegExp(`(#|\\.)(${a})(,|\\{|:|>|\\[)`, "g"), (e, t, o) => o == a ? e.replace(a, A.keys[a]) : e);
        var e = document.createElement("iframe");
        document.body.append(e);
        const i = e.contentWindow.alert.bind(window),
            t = e.contentWindow.prompt.bind(window),
            n = e.contentWindow.confirm.bind(window);
        ...
        const j = {
                global: {
                    name: "Global",
                    img: "https://i.ibb.co/gd4Qs8L/11507ef5615c554fe88fc22c86768501-simple-earth-icon-1.webp",
                    cheats: [{
                        name: "Auto Answer",
                        ...
                        run: async function(t, e, o) {
                            if (window.location.pathname.startsWith("/market")) {
                                ...
                                if (!n) return i("I couldn't find that box!");
                                n = Math.floor(a.state.tokens / n);
                                if (n <= 0) return i("You do not have enough tokens!");
                                ...
                                await new Promise(e => setTimeout(e)), i(`(${Date.now()-n}ms) Results:\n` + Object.entries(s).map(([e, t]) => `    ${e} ` + t).join(`\n`))
                            } else i("This can only be ran in the Market page.")
                        }
                    }, {
                        name: "Flood Game",
                        ...
                        run: function(e) {
                            if ("/host/settings" != location.pathname) return i("Run this script on the host settings page");
                            c().setState({
                                settings: {
                                    type: e
                                }
                        ...
                        run: async function() {
                            ...
                            window.location.href.includes("play.blooket.com") ? (e = ["60101da869e8c70013913b59", "625db660c6842334835cb4c6", "60268f8861bd520016eae038", "611e6c804abdf900668699e3", "60ba5ff6077eb600221b7145", "642467af9b704783215c1f1b", "605bd360e35779001bf57c5e", "6234cc7add097ff1c9cff3bd", "600b1491d42a140004d5215a", "5db75fa3f1fa190017b61c0c", "5fac96fe2ca0da00042b018f", "600b14d8d42a140004d52165", "5f88953cdb209e00046522c7", "600b153ad42a140004d52172", "5fe260e72a505b00040e2a11", "5fe3d085a529560004cd3076", "5f5fc017aee59500041a1456", "608b0a5863c4f2001eed43f4", "5fad491512c8620004918ace", "5fc91a9b4ea2e200046bd49a", "5c5d06a7deebc70017245da7", "5ff767051b68750004a6fd21", "5fdcacc85d465a0004b021b9", "5fb7eea20bd44300045ba495"][Math.floor(24 * Math.random())], t = (e, t) => Math.floor(Math.random() * (t - e + 1)) + e, o = (await fetch("https://play.blooket.com/api/playersessions/solo", {
                                ...
                                method: "POST",
                                credentials: "include"
                            }).then(e => e.json()).catch(() => i("There was an error creating a solo game.")))["t"], await fetch("https://play.blooket.com/api/playersessions/landings", {
                                body: JSON.stringify({
                                    t: o
                                }),
                                method: "POST",
                                credentials: "include"
                            }).catch(() => i("There was an error when landing.")), await fetch("https://play.blooket.com/api/playersessions/questions?t=" + o, {
                                credentials: "include"
                                ...
                                body: JSON.stringify({
                                    ...
                                    upgrades: t(250, 750),
                                    blookUsed: c().props.user.data.blook.name,
                                    nameUsed: "You",
                                    mode: "Time-Solo"
                                }),
                                method: "PUT",
                                credentials: "include"
                            }).catch(() => i("There was an error when spoofing stats.")), await fetch("https://play.blooket.com/api/users/add-rewards", {
                                body: JSON.stringify({
                                    t: o,
                                    addedTokens: 500,
                                    addedXp: 300
                                ...
                                dailyReward: e
                            }) => i(`Added max tokens and xp, and got ${e} daily wheel tokens!`)).catch(() => i("There was an error when adding rewards."))) : (i("This cheat only works on play.blooket.com, opening a new tab."), window.open("https://play.blooket.com/"))
                        }
                    }, {
                        name: "Use Any Blook",
                        ...
                        run: function() {
                            ...
                            })) : i("This only works in lobbies or the dashboard blooks page.")
                        }
                    }, {
                        ...
                        run: function() {
                            document.querySelector('input[class*="nameInput"]').maxLength = 120, i("Removed name length limit")
                        }
                    }, {
                        ...
                        run: async function() {
                            if (window.location.pathname.startsWith("/blooks")) {
                                if (n("Are you sure you want to sell your dupes? (Legendaries and rarer will not be sold)")) {
                                    var o = c();
                                    let e = Date.now(),
                                        t = "";
                                    for (const a in o.state.blookData)
                                        ...
                                        } i(`(${Date.now()-e}ms) Results:\n` + t.trim())
                                }
                            } else i("This can only be ran in the Blooks page.")
                        }
                    }]
                },
                voyage: {
                ...
                brawl: {
                    ...
                    cheats: [{
                        ...
                        run: function() {
                            var o = c().game.current.config.sceneConfig.physics.world.colliders._active.filter(e => e.callbackContext?.toString?.()?.includes?.("dmgCd"));
                        ...
                        run: function() {
                            for (const e of c().game.current.config.sceneConfig.physics.world.colliders._active.filter(e => e.callbackContext?.toString().includes("invulnerableTime") || e.callbackContext?.toString().includes("dmgCd"))) e.collideCallback = () => {}
                        }
                    }, {
                        name: "Kill Enemies",
                        description: "Kills all current enemies",
                        run: function() {
                            c().game.current.config.sceneConfig.physics.world.bodies.entries.forEach(e => e?.gameObject?.receiveDamage?.(e.gameObject.hp, 1))
                        }
                    }, {
                        name: "Magnet",
                        description: "Pulls all xp towards you",
                        run: function() {
                            c().game.current.config.sceneConfig.physics.world.colliders._active.find(e => e.collideCallback?.toString().includes("magnetTime")).collideCallback({
                                active: !0
                            }, {
                                active: !0,
                                setActive() {},
                        ...
                        run: function() {
                            c().game.current.config.sceneConfig.physics.world.bodies.entries.forEach(e => {
                                try {
                        ...
                        run: function() {
                            c().game.current.events._events.respawn.fn()
                        }
                    }, {
                        name: "Set XP",
                ...
                cafe: {
                    name: "Café",
                    img: "https://i.ibb.co/t8pqdYL/hot-beverage-1.png",
                    cheats: [{
                        name: "Max Items",
                        description: "Maxes out items in the shop (Only usable in the shop)",
                        run: function() {
                            var e;
                            "/cafe/shop" !== window.location.pathname ? i("This can only be run in the shop") : (e = c()).setState({
                        ...
                        run: function() {
                            var e;
                            "/cafe" !== window.location.pathname ? i("This can't be run in the shop") : (e = c()).setState({
                    ...
                    cheats: [{
                        ...
                        run: function() {
                            this.enabled ? (this.enabled = !1, clearInterval(this.data), this.data = null) : (this.enabled = !0, this.data = setInterval(() => {
                                ...
                                t.children.length <= 4 && ((e = document.createElement("div")).style.color = "white", e.style.fontFamily = "Inconsolata,Helvetica,monospace,sans-serif", e.style.fontSize = "2em", e.style.display = "flex", e.style.justifyContent = "center", e.style.marginTop = "675px", e.innerText = c().state.choices[0].text, t.append(e))
                            }, 50))
                        }
                    }, {
                        name: "Password ESP",
                        ...
                        data: null,
                        run: function() {
                            this.enabled ? (this.enabled = !1, clearInterval(this.data), this.data = null) : (this.enabled = !0, this.data = setInterval(e => c().setState(e), 25, {
                                choices: [{
                                    type: "mult",
                                    val: 3,
                                    rate: .075,
                ...
                dinos: {
                    ...
                    img: "https://i.ibb.co/JFq5j88/Screenshot-2024-03-26-7-30-21-PM-removebg-preview-1.png",
                    style: {
                ...
                doom: {
                    ...
                    cheats: [{
                        ...
                        run: function() {
                            ...
                            } else i("You need to be on the map to run this cheat!")
                        }
                    }, {
                        name: "Max Cards",
                        ...
                        run: function() {
                            "/tower/battle" == window.location.pathname ? c().setState({
                                myHealth: 100,
                                myLife: 100
                            }) : i("You need to be in battle to run this cheat!")
                        }
                    }, {
                        name: "Max Card Stats",
                        ...
                        run: function() {
                            var e = c();
                            "select" !== e.state.phase ? i("You must be on the attribute selection page!") : e.setState({
                                myCard: {
                                    ...e.state.myCard,
                                    strength: 20,
                                    charisma: 20,
                        ...
                        run: function(e) {
                            if ("/tower/battle" == window.location.pathname) try {
                                c().props.setTowerCoins(e)
                            } catch {} else i("You need to be in battle to run this cheat!")
                        }
                    }]
                },
                factory: {
                    name: "Factory",
                    img: "https://i.ibb.co/VMrTd39/images-removebg-preview-1.png",
                    cheats: [{
                        name: "Choose Blook",
                        ...
                        run: function(e) {
                            var t = c();
                            10 <= t.state.blooks.length && i("Choose a blook to replace"), t.waiting = !1, t.chooseBlook(JSON.parse(e))
                        }
                    }, {
                        name: "Free Upgrades",
                        ...
                        run: function() {
                            c().state.blooks.forEach(e => e.level = 4)
                        }
                    }, {
                ...
                kingdom: {
                    name: "Crazy Kingdom",
                    img: "https://i.ibb.co/10mZ6dx/3763864-1.png",
                    cheats: [{
                        name: "Choice ESP",
                ...
                extras: {
                    name: "Extras",
                    img: "https://i.ibb.co/mb0R9HX/Star-icon-stylized-svg-1-removebg-preview.png",
                    cheats: [{
                        ...
                        run: function(e) {
                            ...
                            let done = false;
                            for (let a = 1; a <= t; a++) {
                                history.pushState(0, 0, a === t ? C : a.toString());
                                if (a === t) done = true;
                            }
                            if (done) {
                                alert("History flood successful! " + window.location.href + " now appears in your history " + t + (t === 1 ? " time." : " times."));
                            }
                        }
                    }, {
                        name: "Tab Cloaker",
                ...
                settings: {
                    name: "Settings",
                    img: "https://i.ibb.co/jrWKgyn/Windows-Settings-icon-1.png",
                    cheats: [{
                        ...
                        run: function(e) {
                            try {
                                ...
                                return i("Invalid JSON provided")
                            }
                            e = {
                        ...
                        run: async function() {
                            await navigator.clipboard.writeText(JSON.stringify(B.data.theme, null, 4)), t("Text copied to clipboard. (Paste below to test)")
                        }
                    }, {
                        name: "Defaults",
                        ...
                        inputs: [{
                            ...
                            min: 25,
                            max: 100,
                            value: 100 * (B.data?.scale || 1)
                        }],
                        run: function(e) {
                            e = Math.min(Math.max(e, 25), 100), B.setItem("scale", e / 100), guiWrapper.style.transform = `scale(${e/100})`
                        }
                    }, {
                        name: "Hide Keybind",
                        ...
                        run: function(e) {
                            B.setItem("theme.backgroundColor", e)
                        }
                    }, {
                        ...
                        run: function(e) {
                            B.setItem("theme.defaultButton", e)
                        }
                    }, {
                        ...
                        run: function(e) {
                            B.setItem("theme.enabledButton", e)
                        }
                    }, {
                        ...
                        run: function(e) {
                            B.setItem("theme.disabledButton", e)
                        }
                    }, {
                        name: "Text Color",
                        ...
                        run: function(e) {
                            B.setItem("theme.contentBackground", e)
                        }
                    }]
                }
            },
        ...
        function o(c, u = window) {
            return new Promise(t => {
                ...
                const i = e => {
                    ...
                    l = e => {
                        delete o[e.code], 0 < Object.keys(o).length || (u.removeEventListener("keydown", i), u.removeEventListener("keyup", l), t({
                            shift: a,
                            ctrl: n,
                            alt: r,
                            key: s
                ...
                u.addEventListener("keydown", i), u.addEventListener("keyup", l)
            })
        }
        ...
        function L({
            ...
            let a = [],
                n = e => y.jsx("span", {
                    ...
                    children: String.fromCharCode(Math.floor(25 * Math.random()) + 97)
                });
            var r = t => {
                if ("string" == typeof t) {
                    var o = [];
                    for (let e = 0; e < t.length; e += 3) o.push(t.slice(e, e + 3), n());
                    a.push(...o)
                } else a.push(t, n())
            };
            if (Array.isArray(t))
        ...
        function r({
            ...
            let u;
            try {
                u = "function" == typeof t ? t() : t
            } catch (e) {
                console.warn(e), u = []
            }
            const [d, p] = C(u), [m, h] = C(""), g = S(!0);
            M(() => {
                d instanceof Promise ? d.then(e => {
                    p(e), a(e[0]?.value || e[0]), o.selected = e[0]?.name || e[0], g.current = !1
                }).catch(() => p([])) : d?.length && (a(d[0]?.value || d[0]), o.selected = d[0]?.name || d[0]), "number" == s ? a(c || (null == i ? 0 : i)) : "function" == s ? a(null) : d instanceof Promise || d?.length || a("")
            }, []);
            let f;
            if ("options" == s && d?.length) f = y.jsx("select", {
                onChange: e => (o.selected = e.target.children[e.target.selectedIndex].innerText, a(JSON.parse(e.target.value))),
                children: d.map(e => y.jsx("option", {
                    value: JSON.stringify(null != e?.value ? e.value : e),
                    children: e?.name || e
                }))
            });
            else if ("function" == s) f = y.jsx("input", {
                className: A.keys.cheatInput,
                placeholder: r,
                style: {
                    textAlign: "center"
                },
                ...
                onClick: async () => {
                    if (!m) {
                        h("Waiting for input...");
                        let t;
                        var e = await o.function(e => h((t = e) + "..."));
                        o.data = t, h(!1), a(e)
                    }
                }
            });
                ...
                let t = "number" == s;
                f = y.jsx("input", {
                    onChange: e => a(t ? parseInt(e.target.value) : e.target.value),
                    className: A.keys.cheatInput,
                    type: t ? "number" : null,
                    min: t ? i : null,
                    max: t ? l : null,
                    defaultValue: t ? c || (null == i ? 0 : i) : null,
                    placeholder: r,
                    style: {
                        textAlign: "center",
                        backgroundColor: e && "#0003"
                    },
                    onKeyUp: e => "Enter" == e.key && n()
                })
            }
            return f
        }
        ...
        function D({
            ...
            const a = S([]),
                [e, t] = C(o.enabled),
                n = x(() => {
                    o.run.apply(o, a.current), t(o.enabled)
                }, []);
            return T("div", {
                style: {
                    background: "toggle" == o.type ? e ? "var(--enabledButton)" : "var(--disabledButton)" : "var(--defaultButton)"
                },
                key: o.name,
                "data-tip": o.description,
                className: A.keys.scriptButton,
                onClick: e => (e.target.matches("." + A.keys.scriptButton) || e.target.matches("." + A.keys.cheatName) || e.target.matches(`.${A.keys.cheatName} *`)) && n()
            }, T(L, {
                className: A.keys.cheatName
            }, o.name), o.inputs?.length && o.inputs.map((e, t) => e.element || T(r, {
                onValue: e => a.current[t] = e,
                key: t,
                input: e,
                run: n,
                toggle: "toggle" == o.type
            })))
        }
        ...
        function N({
            ...
            return M(() => {
                const e = () => r.current = !1,
                    t = e => {
                        var t, o;
                        r.current && (t = s.current.x - e.clientX, o = s.current.y - e.clientY, s.current = {
                            x: e.clientX,
                            y: e.clientY
                        }, n({
                            x: a.offsetLeft - t,
                ...
                return document.addEventListener("pointerup", e), document.addEventListener("pointermove", t), () => {
                    document.removeEventListener("pointerup", e), document.removeEventListener("pointermove", t)
                }
            }, [a]), T("div", {
                ...t,
                onPointerDown: e => {
        ...
        function a() {
            ...
            var e = x(({
                ...
                o.x = e, o.y = t, l.current.style.left = e + "px", l.current.style.top = t + "px"
            }, []);
            const [t, a] = C(null), [n, r] = C(!1), [s, i] = C("global"), l = S();
            S();
            B = function(o) {
                const [a, r] = C(JSON.parse(localStorage.getItem(o) || "{}")), t = x((e, n) => (e.split(".").reduce((e, t, o, a) => (++o == a.length && (e[t] = n), e[t]), a), localStorage.setItem(o, JSON.stringify(a)), r({
                    ...a
                }), a), [a]), n = x((e, t) => (e.split(".").reduce((e, t, o, a) => (++o == a.length && delete e[t], e[t]), a), localStorage.setItem(o, JSON.stringify(a)), r({
                    ...a
                }), a), [a]), s = x(e => {
                    r(e), localStorage.setItem(o, JSON.stringify(e))
                }, []);
                return M(() => {
                    try {
                        r(JSON.parse(localStorage.getItem(o) || "{}"));
                        for (const e of ["backgroundColor", "cheatList", "contentBackground", "defaultButton", "disabledButton", "enabledButton", "infoColor", "inputColor", "textColor"]) B.data[e] && (t("theme." + e, B.data[e]), n(e))
                    } catch {
                        s({})
                    }
                }, []), {
            ...
            return M(() => {
                ...
                let o = e => {
                    ...
                    (t.ctrl && e.ctrlKey || !t.ctrl && !e.ctrlKey) && (t.shift && e.shiftKey || !t.shift && !e.shiftKey) && (t.alt && e.altKey || !t.alt && !e.altKey) && e.key.toLowerCase() == t.key ? (e.preventDefault(), r(e => !e)) : (o.ctrl && e.ctrlKey || !o.ctrl && !e.ctrlKey) && (o.shift && e.shiftKey || !o.shift && !e.shiftKey) && (o.alt && e.altKey || !o.alt && !e.altKey) && e.key.toLowerCase() == o.key && (e.preventDefault(), y())
                };
                return window.addEventListener("keydown", o), () => {
                    window.removeEventListener("keydown", o);
                    for (const e of f)
                        for (const t of j[e].cheats) t.enabled && t.run()
                }
            }, []), M(() => {
                if (null == t) return () => {};
                var e = l.current.querySelector("div");
                e.style.height = t ? "55px" : "100%", e.style.width = t ? "165px" : "100%", l.current.style.top = parseInt(l.current.style.top) + (l.current.offsetHeight - 55) * (t ? 1 : -1) + "px", l.current.style.left = parseInt(l.current.style.left) + (l.current.offsetWidth - 165) * (t ? 1 : -1) + "px", l.current.style.pointerEvents = t ? "none" : "unset"
            }, [t]), T("div", {
                ref: l,
                id: A.keys.guiWrapper,
                style: {
                    top: o.y + "px",
                    left: o.x + "px",
                    transform: `scale(${B.data.scale||1})`,
                    display: n ? "none" : null
                }
            }, T("style", null, A.css), g, T("div", {
                id: A.keys.gui
            }, T("div", {
                id: A.keys.controlButtons
            }, T(N, {
                parent: l.current,
                setPos: e,
                style: {
            ...
            }))), !t && T(b.Fragment, null, T("div", {
                id: A.keys.background
            }, T("div", {
                id: A.keys.backgroundImage
            })), T(N, {
                parent: l.current,
                setPos: e,
                id: A.keys.controls
                ...
                ctrl: !0,
                key: "x"
            }], T(b.Fragment, null, `${[g&&"Ctrl",e&&"Shift",c&&"Alt",u&&u.toUpperCase()].filter(Boolean).join(" + ")} to hide | ${[d&&"Ctrl",p&&"Shift",m&&"Alt",h&&h.toUpperCase()].filter(Boolean).join(" + ")} for quick disable`, T("br", null), T(L, null, "Click and drag here")))), T("div", {
                id: A.keys.credits
            }, T(L, {
                ...
                href: "https://github.com/DannyDan0167/Blooket-Cheats-Plus"
            }, "GitHub - DannyDan0167")), T("div", {
                id: A.keys.cheatList
            }, T(L, {
                type: "span",
                style: {
                ...
                type: b.Fragment
            }, "Discord")), f.map(e => T("div", {
                key: e,
                onClick: () => i(e),
                className: A.keys.cheatButton
            }, j[e].img ? T("img", {
                src: j[e].img,
                style: {
                    maxWidth: "30px",
                ...
                id: A.keys.cheats
            }, j[s].element || (j[s].element = T(b.Fragment, null, T("div", {
                className: A.keys.headerText
            }, T(L, null, j[s].name, " Cheats")), j[s].cheats.map(e => e.element || T(D, {
                key: e.name + e.type,
                script: e
            }))))))))))
        }
        console.log(y.jsx(a, {})), v.render(y.jsx(a, {}), I), document.body.append(I)
    };
    let d = new Image;
    d.src = "https://raw.githubusercontent.com/DannyDan0167/Blooket-Cheats-Plus/main/Update/Others/reactGui.png?" + Date.now(), d.crossOrigin = "Anonymous", d.onload = function() {
        ...
        let s, i = 1716839383825,
            l = "There was an error checking for script updates. Run cheat anyway?";
        try {
            [s, i, l] = o.match(/LastUpdated: (.+?); ErrorMessage: "((.|\n)+?)"/)
        } catch (e) {}(parseInt(i) <= 1716839383825 || c.contentWindow.confirm(l)) && u()
    }, d.onerror = d.onabort = () => {
        d.onerror = d.onabort = null, u(), document.querySelector("iframe").contentWindow.alert("It seems the GitHub is either blocked or down.\n\nIf it's NOT blocked, join the Discord server for updates\nhttps://discord.gg/8A6J234n7v\n(The cheat will still run after this alert)")
    }
})();
